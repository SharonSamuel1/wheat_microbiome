...
samples_directory="/home/projects/zeevid/samuelsh/wheat_microbiome-2024/results/microbiome/fastqc_after_trim"
...
if [ -s "${file_list}" ]; then
    ...
    multiqc --file-list "${file_list}" -o "/home/projects/zeevid/samuelsh/wheat_microbiome-2024/results/microbiome//multiqc"
fi
